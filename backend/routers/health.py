...
async def prometheus_metrics():
    ...
    lines = [
        f"# HELP facevoiceauth_uptime_seconds Server uptime in seconds",
        f"# TYPE facevoiceauth_uptime_seconds gauge",
        f"facevoiceauth_uptime_seconds {uptime}",
        f"",
        f"# HELP facevoiceauth_requests_total Total API requests",
        f"# TYPE facevoiceauth_requests_total counter",
        f'facevoiceauth_requests_total {_metrics["requests_total"]}',
        f"",
        f"# HELP facevoiceauth_auth_success_rate Authentication success rate",
        f"# TYPE facevoiceauth_auth_success_rate gauge",
        f"facevoiceauth_auth_success_rate {success_rate}",
        f"",
        f"# HELP facevoiceauth_face_verify_latency_ms Average face verification latency",
        f"# TYPE facevoiceauth_face_verify_latency_ms gauge",
        f"facevoiceauth_face_verify_latency_ms {round(avg_face_latency, 2)}",
        f"",
        f"# HELP facevoiceauth_voice_verify_latency_ms Average voice verification latency",
        f"# TYPE facevoiceauth_voice_verify_latency_ms gauge",
        f"facevoiceauth_voice_verify_latency_ms {round(avg_voice_latency, 2)}",
        f"",
        f"# HELP facevoiceauth_voice_liveness_rejection_rate Voice liveness rejection rate",
        f"# TYPE facevoiceauth_voice_liveness_rejection_rate gauge",
